  ...
  return (
    <section id="contacto" className="py-12 bg-white">
      <div className="max-w-[980px] mx-auto px-4">
        ...
        <div className="bg-primary-dark rounded-2xl p-6 md:p-10">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end pt-1">
                    <button
                      type="submit"
                      className="bg-accent-green hover:bg-accent-green-dark text-primary-darker font-heading font-bold py-3 px-10 rounded-md transition-colors text-base"
                    >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/20">
                    ...
                    <div className="flex items-center gap-3">
                      <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/60 hover:text-accent-pink transition-colors">
                      ...
                      <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/60 hover:text-accent-blue transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

  ...
  return (
    <>
      ...
      <section className="py-12 bg-primary text-white text-center">
        <div className="max-w-[980px] mx-auto px-4">
          <h2 className="font-heading text-3xl font-bold mb-6">{sobreAcademiaPage.ctaTitle}</h2>
          ...
          <a
            href="#contacto"
            className="inline-block bg-accent-green hover:bg-accent-green-dark text-primary-darker font-heading font-bold py-3 px-8 rounded-md transition-colors"
          >
            ¡Contáctanos!
          </a>
        </div>
      ...
      <section className="py-12 bg-warm">
        <div className="max-w-[980px] mx-auto px-4 text-center">
          <h2 className="font-heading text-3xl font-bold text-primary-dark mb-6">Ubicación</h2>
